...
void filereader()
{
    FILE *f_pow = fopen("power_reallife.csv", "r");
    FILE *f_task = fopen("task_reallife.csv", "r");
...
void displaytable(){
    ...
    printTableRow("Profit after phase 2", to_string(profit_phase2));
...
int main()
{
    ...
    helper();
    displaytable();
   // cout<<"\nval is "<<calculateU(0.0)<<endl;
    // cout<<(1.0*UtoPOW(49))<<endl;
    // cout<<(1.0*UtoPOW(47))<<endl;
    // cout<<UtoPOW(37)<<endl;
     //displayUtils();
